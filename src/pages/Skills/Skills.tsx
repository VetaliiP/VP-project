            ...
            <div className='wrapper'>
                <div className='flex flex-row justify-between'>
                    <div className='flex flex-col justify-between items-center flex-1'>
                        ...
                        <div className='flex flex-col self-start py-4 font-work gap-1'>
                            <span className='flex flex-row'>
                                ...
                                <div className=' bg-amber-50 text-black rounded-r-[10px] px-2 pt-4  text-2xl '>
                                    Web Development
                                </div>
                            </span>
                            <span className='flex flex-row'>
                                <div className='bg-amber-50 text-black rounded-l-[10px] pl-2 py-4 self-end flex-1 text-left'>Name:</div>
                                <div className='border-3 border-amber-50 rounded-r-[10px] px-2 py-2 text-2xl  text-right'>Vitalii</div>
                            </span>
                            <span className='flex flex-row'>
                                <div className='bg-amber-50 text-black rounded-l-[10px] pl-2 py-4 self-end flex-1 text-left'>Surname:</div>
                                <div className='border-3 border-amber-50 rounded-r-[10px] px-2 py-2 text-2xl  text-right'>Pererva</div>
                            </span>
                            <span className='flex flex-row'>
                                <div className='bg-amber-50 text-black rounded-l-[10px] pl-2 py-4 self-end flex-1 text-left'>Age:</div>
                                <div className='border-3 border-amber-50 rounded-r-[10px] px-2 py-2 text-2xl text-right'>32</div>
                            </span>
                            <span className='flex flex-row'>
                                <div className='bg-amber-50 text-black rounded-l-[10px] pl-2 py-4 self-end flex-1 text-left'>Mail:</div>
                        ...
                        <div className='skills_page flex flex-row gap-4 py-4 self-start items-center'>
                            ...
                            <div>
                                <input type="radio" name="page_skills" value="tried" id="tried" className='hidden'
                                    onChange={(e) => setSelectedSkill(e.target.value)}
                                />
                                <label htmlFor="tried"
                                    className={` ${(selectedSkill === "tried") ? 'active_button' : 'not_active_button'} cursor-pointer font-bebas text-xl select-none`}
                                >
                                    Tried
                                </label>
                            </div>
                    ...
                    <div className='photo_block flex flex-col justify-between items-center w-[200px]'>
                        <div className='size-full bg-amber-50 rounded-2xl text-black flex justify-center items-center flex-2'>
                            #Photo
                        </div>
                        <div className='flex flex-row justify-around py-4 w-full flex-2 '>
                            <div>
                ...
                <div>
                    <div className={`skills_blocks flex flex-row flex-wrap justify-center items-center gap-4 p-4 ${(selectedSkill === "using") ? ' opacity-100 ' : 'hidden opacity-0'} transition-all duration-300`}>
                    ...
                    <div className={`skills_blocks flex flex-row flex-wrap justify-center items-center gap-4 p-4 ${(selectedSkill === "practiced") ? 'opacity-100 ' : 'hidden opacity-0'} transition-all duration-300`}>
                        <div className='skills_block'>
                            <span>Astra</span>
                            {/* <span>star</span> */}
                        </div>
                ...
                <div className='flex flex-col py-4'>
                    ...
                    <div className={`skills_blocks flex flex-row flex-wrap justify-center items-center gap-4 p-4`}>
                        <div className='skills_block'>
