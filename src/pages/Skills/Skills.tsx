                ...
                <div className='flex sm:flex-row  sm:justify-between sm:items-stretch flex-col-reverse items-center'>
                    ...
                    <div className='photo_block flex flex-col justify-between items-center sm:w-[200px] w-full '>
                        ...
                        <div className='flex flex-row justify-around py-4 w-full flex-0 cursor-pointer'>
                            ...
                            <div>
                                <a href="https://t.me/VetaliiP" target="_blank" rel="noopener noreferrer" className="text-amber-50 underline">
                            ...
                            <div>
                                <a href="https://www.facebook.com/VetaliiPererva" target="_blank" rel="noopener noreferrer" className="text-amber-50 underline">
                            ...
                            <div>
                                <a href="https://www.linkedin.com/in/vitaliipererva" target="_blank" rel="noopener noreferrer" className="text-amber-50 underline">
